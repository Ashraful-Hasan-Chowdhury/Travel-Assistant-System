    ...
    <div class="col-md-10 offset-1">
      <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Hotel Manager Informations</h3>
              </div>
              @if ($errors->any())
            ...
            @endif
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group" >
                    <label for="exampleInputEmail1">Hotel Documents Image</label>
                    <center>
                      <img src="{{ asset($profile->hotel_doc) }}" alt="no image found" style="width: 300px;height: 200px;">
                    </center>
                  </div>
                  

                   <a href="{{ route('approve.manager',$profile->id) }}" class="btn btn-md btn-success">Approve</a>
