...
<section class="ftco-section">
 ...
 --}}    						</div>
    						<p> <span><h6>Description:</h6></span> {{ $place->desciption }}</p>
    						<p id="app"><place-map :latval="{{ $place->lat }}" :lngval="{{ $place->lng }}"></place-map></p>
    						<hr>
    						<p> <span><h6>Direction to Visit:</h6></span> {{ $place->direction }}</p>
    						<p class="bottom-area d-flex">
    							...
    							<span class="ml-auto float-right"><a href="{{ route('places') }}" class=" btn btn-success btn-sm">Back</a></span>
    						</p>
    					</div>
    				</div>
    			</div>
...
<section class="ftco-section" >
        <div class="container">
                <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2 class="mb-4">Reviews of This Place</h2>
          </div>
        </div>
        </div>
        <div class="container-fluid">
